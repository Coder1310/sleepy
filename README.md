...
- отдельного режима Power Nap 10-20 минут
...
2. Отдельный сценарий "Power Nap 10-20 мин"
3. Сценарий "Дневной сон / перерыв"
4. Сохранение записи после сна
5. История последних записей
6. Простая статистика
7. Будильник с кодом выключения
8. Восстановление активных будильников после перезапуска приложения
